...
# def get_ip_seg_len(ip_seg):
#     return ipaddress.ip_network(ip_seg, strict=False).num_addresses
...
def get_ip_seg_len(ip_seg: str) -> int:
    ...
    if "-" in ip_seg:
        ...
        start = ipaddress.ip_address(start.strip())
        end = ipaddress.ip_address(end.strip())
...
def get_all_ip(ip_seg: str):
    ...
    if "-" in ip_seg:
        ...
        network = ipaddress.ip_network(ip_seg, strict=False)
